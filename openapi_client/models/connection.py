...
class Connection(BaseModel):
    ...
    name: StrictStr = Field(description="The name of the Connection.", alias="Name")
    ...
    server_endpoint: StrictStr = Field(description="The server endpoint of the connection.", alias="ServerEndpoint")
