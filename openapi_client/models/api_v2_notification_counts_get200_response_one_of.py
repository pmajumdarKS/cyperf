...
class ApiV2NotificationCountsGet200ResponseOneOf(BaseModel):
    """
    ApiV2NotificationCountsGet200ResponseOneOf
    """ # noqa: E501
    data: Optional[NotificationCounts] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": NotificationCounts.from_dict(obj["data"]) if obj.get("data") is not None else None,
