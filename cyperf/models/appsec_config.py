...
class AppsecConfig(BaseModel):
    ...
    config_type_name: Optional[StrictStr] = Field(default=None, description="Used for API clients to decide what type of config they have loaded", alias="configTypeName")
