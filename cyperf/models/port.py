...
class Port(BaseModel):
    ...
    traffic_status: Optional[StrictStr] = Field(default=None, alias="trafficStatus")
    __properties: ClassVar[List[str]] = ["disabled", "id", "name", "owner", "ownerId", "speed", "status", "trafficStatus"]
