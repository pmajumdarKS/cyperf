...
#        try:
#            self.values =  self.link_based_request(field_info.alias, "GET", return_type="List[str]")
#        except LinkNameException as e:
#            self.values =  self.link_based_request("values", "GET", return_type="List[str]")
#        return self.values
#
#    @rest_values.setter
