...
#    api_client: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["TLSClientProfile", "UDPProfile"]
...
#    @property
#    def rest_tls_client_profile(self):
#        if self.tls_client_profile is not None:
#            return self.tls_client_profile
#        field_info = self.__class__.__fields__["tls_client_profile"]
#        try:
#            self.tls_client_profile =  self.link_based_request(field_info.alias, "GET", return_type="TLSProfile")
#        except LinkNameException as e:
#            self.tls_client_profile =  self.link_based_request("tls_client_profile", "GET", return_type="TLSProfile")
#        return self.tls_client_profile
#
#    @rest_tls_client_profile.setter
#    def rest_tls_client_profile(self, value):
#        self.tls_client_profile = value
