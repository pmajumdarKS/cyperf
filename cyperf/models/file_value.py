...
#        try:
#            self.payload =  self.link_based_request(field_info.alias, "GET", return_type="List[bytearray]")
#        except LinkNameException as e:
#            self.payload =  self.link_based_request("payload", "GET", return_type="List[bytearray]")
#        return self.payload
#
#    @rest_payload.setter
