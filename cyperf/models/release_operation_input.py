...
if "ReleaseOperationInput" != "APILink":
...
#        try:
#            self.agents_data =  self.link_based_request(field_info.alias, "GET", return_type="List[AgentRelease]")
#        except LinkNameException as e:
#            self.agents_data =  self.link_based_request("agents_data", "GET", return_type="List[AgentRelease]")
#        return self.agents_data
#
