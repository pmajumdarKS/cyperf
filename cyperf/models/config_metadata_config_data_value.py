...
CONFIGMETADATACONFIGDATAVALUE_ANY_OF_SCHEMAS = ["List[object]", "bool", "float", "int", "object", "str"]

class ConfigMetadataConfigDataValue(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ConfigMetadataConfigDataValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ConfigMetadataConfigDataValue with anyOf schemas: List[object], bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return v
...
#        instance.api_client = client
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ConfigMetadataConfigDataValue with anyOf schemas: List[object], bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
