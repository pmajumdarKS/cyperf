...
class ApiV2SessionsSessionIdConfigGet200ResponseOneOf(BaseModel):
    """
    ApiV2SessionsSessionIdConfigGet200ResponseOneOf
    """ # noqa: E501
    data: Optional[AppsecConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AppsecConfig.from_dict(obj["data"]) if obj.get("data") is not None else None,
