    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.export_files_requests_by_agent:
            for _key_export_files_requests_by_agent in self.export_files_requests_by_agent:
                if self.export_files_requests_by_agent[_key_export_files_requests_by_agent] is not None:
                    _field_dict_of_array[_key_export_files_requests_by_agent] = [
                        _item.to_dict() for _item in self.export_files_requests_by_agent[_key_export_files_requests_by_agent]
                    ]
