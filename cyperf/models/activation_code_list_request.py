...
if "ActivationCodeListRequest" != "APILink":
...
#        try:
#            self.activation_code =  self.link_based_request(field_info.alias, "GET", return_type="List[str]")
#        except LinkNameException as e:
#            self.activation_code =  self.link_based_request("activation_code", "GET", return_type="List[str]")
#        return self.activation_code
#
