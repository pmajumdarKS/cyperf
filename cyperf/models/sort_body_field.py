...
#            return self.order
#        field_info = self.__class__.__fields__["order"]
#        try:
#            self.order =  self.link_based_request(field_info.alias, "GET", return_type="str")
#        except LinkNameException as e:
#            self.order =  self.link_based_request("order", "GET", return_type="str")
#        return self.order
#
#    @rest_order.setter
#    def rest_order(self, value):
#        self.order = value
