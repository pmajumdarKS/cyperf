...
#            return self.key
#        field_info = self.__class__.__fields__["key"]
#        try:
#            self.key =  self.link_based_request(field_info.alias, "GET", return_type="str")
#        except LinkNameException as e:
#            self.key =  self.link_based_request("key", "GET", return_type="str")
#        return self.key
#
#    @rest_key.setter
