...
#    @property
#    def rest_choices(self):
#        if self.choices is not None:
#            return self.choices
#        field_info = self.__class__.__fields__["choices"]
#        try:
#            self.choices =  self.link_based_request(field_info.alias, "GET", return_type="List[Choice]")
#        except LinkNameException as e:
#            self.choices =  self.link_based_request("choices", "GET", return_type="List[Choice]")
#        return self.choices
#
#    @rest_choices.setter
#    def rest_choices(self, value):
#        self.choices = value
