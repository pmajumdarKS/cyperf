...
if "TypeArrayV2Metadata" != "APILink":
...
#        try:
#            self.elements =  self.link_based_request(field_info.alias, "GET", return_type="List[ArrayV2ElementMetadata]")
#        except LinkNameException as e:
#            self.elements =  self.link_based_request("elements", "GET", return_type="List[ArrayV2ElementMetadata]")
#        return self.elements
#
