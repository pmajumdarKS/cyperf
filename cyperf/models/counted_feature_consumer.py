...
if "CountedFeatureConsumer" != "APILink":
...
#        try:
#            self.app =  self.link_based_request(field_info.alias, "GET", return_type="str")
#        except LinkNameException as e:
#            self.app =  self.link_based_request("app", "GET", return_type="str")
#        return self.app
#
#    @rest_app.setter
...
#            return self.client
#        field_info = self.__class__.__fields__["client"]
#        try:
#            self.client =  self.link_based_request(field_info.alias, "GET", return_type="str")
#        except LinkNameException as e:
#            self.client =  self.link_based_request("client", "GET", return_type="str")
#        return self.client
#
#    @rest_client.setter
...
#    @property
#    def rest_consumed_count(self):
#        if self.consumed_count is not None:
#            return self.consumed_count
#        field_info = self.__class__.__fields__["consumed_count"]
#        try:
#            self.consumed_count =  self.link_based_request(field_info.alias, "GET", return_type="int")
#        except LinkNameException as e:
#            self.consumed_count =  self.link_based_request("consumed_count", "GET", return_type="int")
#        return self.consumed_count
#
#    @rest_consumed_count.setter
#    def rest_consumed_count(self, value):
#        self.consumed_count = value
