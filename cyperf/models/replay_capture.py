...
#    api_client: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["flows", "id", "name"]
...
#            return self.flows
#        field_info = self.__class__.__fields__["flows"]
#        try:
#            self.flows =  self.link_based_request(field_info.alias, "GET", return_type="List[AppFlow]")
#        except LinkNameException as e:
#            self.flows =  self.link_based_request("flows", "GET", return_type="List[AppFlow]")
#        return self.flows
#
#    @rest_flows.setter
#    def rest_flows(self, value):
#        self.flows = value
