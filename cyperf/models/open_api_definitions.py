    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.open_api_definitions:
            for _key_open_api_definitions in self.open_api_definitions:
                if self.open_api_definitions[_key_open_api_definitions]:
                    _field_dict[_key_open_api_definitions] = self.open_api_definitions[_key_open_api_definitions].to_dict()
