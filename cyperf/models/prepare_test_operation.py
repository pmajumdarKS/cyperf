...
if "PrepareTestOperation" != "APILink":
...
#        try:
#            self.options =  self.link_based_request(field_info.alias, "GET", return_type="PreparedTestOptions")
#        except LinkNameException as e:
#            self.options =  self.link_based_request("options", "GET", return_type="PreparedTestOptions")
#        return self.options
#
#    @rest_options.setter
