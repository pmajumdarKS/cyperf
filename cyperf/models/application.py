...
#    @property
#    def rest_inherit_tls(self):
#        if self.inherit_tls is not None:
#            return self.inherit_tls
#        field_info = self.__class__.__fields__["inherit_tls"]
#        try:
#            self.inherit_tls =  self.link_based_request(field_info.alias, "GET", return_type="bool")
#        except LinkNameException as e:
#            self.inherit_tls =  self.link_based_request("inherit_tls", "GET", return_type="bool")
#        return self.inherit_tls
#
#    @rest_inherit_tls.setter
#    def rest_inherit_tls(self, value):
#        self.inherit_tls = value

#    @property
#    def rest_is_stateless_stream(self):
#        if self.is_stateless_stream is not None:
#            return self.is_stateless_stream
#        field_info = self.__class__.__fields__["is_stateless_stream"]
#        try:
#            self.is_stateless_stream =  self.link_based_request(field_info.alias, "GET", return_type="bool")
#        except LinkNameException as e:
#            self.is_stateless_stream =  self.link_based_request("is_stateless_stream", "GET", return_type="bool")
#        return self.is_stateless_stream
#
#    @rest_is_stateless_stream.setter
#    def rest_is_stateless_stream(self, value):
#        self.is_stateless_stream = value

#    @property
#    def rest_objective_weight(self):
#        if self.objective_weight is not None:
#            return self.objective_weight
#        field_info = self.__class__.__fields__["objective_weight"]
#        try:
#            self.objective_weight =  self.link_based_request(field_info.alias, "GET", return_type="int")
#        except LinkNameException as e:
#            self.objective_weight =  self.link_based_request("objective_weight", "GET", return_type="int")
#        return self.objective_weight
#
#    @rest_objective_weight.setter
#    def rest_objective_weight(self, value):
#        self.objective_weight = value
...
#    @property
#    def rest_stateless_stream(self):
#        if self.stateless_stream is not None:
#            return self.stateless_stream
#        field_info = self.__class__.__fields__["stateless_stream"]
#        try:
#            self.stateless_stream =  self.link_based_request(field_info.alias, "GET", return_type="StatelessStream")
#        except LinkNameException as e:
#            self.stateless_stream =  self.link_based_request("stateless_stream", "GET", return_type="StatelessStream")
#        return self.stateless_stream
#
#    @rest_stateless_stream.setter
#    def rest_stateless_stream(self, value):
#        self.stateless_stream = value
...
#    @property
#    def rest_supported_apps(self):
#        if self.supported_apps is not None:
#            return self.supported_apps
#        field_info = self.__class__.__fields__["supported_apps"]
#        try:
#            self.supported_apps =  self.link_based_request(field_info.alias, "GET", return_type="List[str]")
#        except LinkNameException as e:
#            self.supported_apps =  self.link_based_request("supported_apps", "GET", return_type="List[str]")
#        return self.supported_apps
#
#    @rest_supported_apps.setter
#    def rest_supported_apps(self, value):
...
#    @property
#    def rest_tracks(self):
#        if self.tracks is not None:
#            return self.tracks
#        field_info = self.__class__.__fields__["tracks"]
#        try:
#            self.tracks =  self.link_based_request(field_info.alias, "GET", return_type="List[Track]")
#        except LinkNameException as e:
#            self.tracks =  self.link_based_request("tracks", "GET", return_type="List[Track]")
#        return self.tracks
#
#    @rest_tracks.setter
#    def rest_tracks(self, value):
#        self.tracks = value
