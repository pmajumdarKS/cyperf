...
if "EmulatedSubnetConfig" != "APILink":
...
#    @property
#    def rest_host_count_per_tunnel(self):
#        if self.host_count_per_tunnel is not None:
#            return self.host_count_per_tunnel
#        field_info = self.__class__.__fields__["host_count_per_tunnel"]
#        try:
#            self.host_count_per_tunnel =  self.link_based_request(field_info.alias, "GET", return_type="int")
#        except LinkNameException as e:
#            self.host_count_per_tunnel =  self.link_based_request("host_count_per_tunnel", "GET", return_type="int")
#        return self.host_count_per_tunnel
#
#    @rest_host_count_per_tunnel.setter
#    def rest_host_count_per_tunnel(self, value):
#        self.host_count_per_tunnel = value
...
#    @property
#    def rest_total_host_count(self):
#        if self.total_host_count is not None:
#            return self.total_host_count
#        field_info = self.__class__.__fields__["total_host_count"]
#        try:
#            self.total_host_count =  self.link_based_request(field_info.alias, "GET", return_type="str")
#        except LinkNameException as e:
#            self.total_host_count =  self.link_based_request("total_host_count", "GET", return_type="str")
#        return self.total_host_count
#
#    @rest_total_host_count.setter
#    def rest_total_host_count(self, value):
