...
class IPRange(BaseModel):
    ...
    host_ip_incr: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The Host IP incrementation rule (default: 0.0.0.1).", alias="HostIpIncr")
    ...
    __properties: ClassVar[List[str]] = ["AutomaticIpType", "Count", "GwAuto", "GwStart", "HostCount", "HostIpIncr", "InnerVlanRange", "IpAuto", "IpIncr", "IpRangeName", "IpStart", "IpVer", "IsEmulatedRouter", "Mss", "MssAuto", "NetMask", "NetMaskAuto", "id", "links", "maxCountPerAgent", "networkTags"]
    ...
    @field_validator('host_ip_incr')
    def host_ip_incr_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
