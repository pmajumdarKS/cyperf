...
#        try:
#            self.type_info =  self.link_based_request(field_info.alias, "GET", return_type="ParamMetadataTypeInfo")
#        except LinkNameException as e:
#            self.type_info =  self.link_based_request("type_info", "GET", return_type="ParamMetadataTypeInfo")
#        return self.type_info
#
