...
#        try:
#            self.error =  self.link_based_request(field_info.alias, "GET", return_type="str")
#        except LinkNameException as e:
#            self.error =  self.link_based_request("error", "GET", return_type="str")
#        return self.error
#
#    @rest_error.setter
