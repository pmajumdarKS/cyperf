...
#        try:
#            self.actions =  self.link_based_request(field_info.alias, "GET", return_type="List[AttackAction]")
#        except LinkNameException as e:
#            self.actions =  self.link_based_request("actions", "GET", return_type="List[AttackAction]")
#        return self.actions
#
#    @rest_actions.setter
