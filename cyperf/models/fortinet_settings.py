...
#    api_client: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["AuthSettings", "OuterTCPProfile", "FortinetEncapsulation", "OuterTLSClientProfile", "VPNGateway"]
...
#    @property
#    def rest_fortinet_encapsulation(self):
#        if self.fortinet_encapsulation is not None:
#            return self.fortinet_encapsulation
#        field_info = self.__class__.__fields__["fortinet_encapsulation"]
#        try:
#            self.fortinet_encapsulation =  self.link_based_request(field_info.alias, "GET", return_type="FortinetEncapsulation")
#        except LinkNameException as e:
#            self.fortinet_encapsulation =  self.link_based_request("fortinet_encapsulation", "GET", return_type="FortinetEncapsulation")
#        return self.fortinet_encapsulation
#
#    @rest_fortinet_encapsulation.setter
#    def rest_fortinet_encapsulation(self, value):
#        self.fortinet_encapsulation = value
