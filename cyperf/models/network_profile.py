    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.dut_network_segment:
            for _item_dut_network_segment in self.dut_network_segment:
                if _item_dut_network_segment:
                    _items.append(_item_dut_network_segment.to_dict())
        ...
        if self.ip_network_segment:
            for _item_ip_network_segment in self.ip_network_segment:
                if _item_ip_network_segment:
                    _items.append(_item_ip_network_segment.to_dict())
