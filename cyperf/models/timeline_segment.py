    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.secondary_objective_values:
            for _item_secondary_objective_values in self.secondary_objective_values:
                if _item_secondary_objective_values:
                    _items.append(_item_secondary_objective_values.to_dict())
