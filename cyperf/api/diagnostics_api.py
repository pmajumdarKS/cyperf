...
class DiagnosticsApi:
    ...
    @validate_call
    def api_v2_diagnostics_components_get(
        self,
        ...
        _param = self._api_v2_diagnostics_components_get_serialize(
    ...
    def api_v2_diagnostics_components_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DiagnosticComponent]]:
        """api_v2_diagnostics_components_get
    ...
    def _api_v2_diagnostics_components_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/diagnostics/components',
    ...
    @validate_call
    def api_v2_diagnostics_operations_delete_delete(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._api_v2_diagnostics_operations_delete_delete_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _api_v2_diagnostics_operations_delete_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/diagnostics/operations/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api_v2_diagnostics_operations_delete_id_delete(
        self,
        ...
        _param = self._api_v2_diagnostics_operations_delete_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _api_v2_diagnostics_operations_delete_id_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/diagnostics/operations/delete/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api_v2_diagnostics_operations_export_get(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._api_v2_diagnostics_operations_export_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _api_v2_diagnostics_operations_export_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/diagnostics/operations/export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api_v2_diagnostics_operations_export_id_get(
        self,
        ...
        _param = self._api_v2_diagnostics_operations_export_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _api_v2_diagnostics_operations_export_id_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/diagnostics/operations/export/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api_v2_diagnostics_operations_export_id_result_get(
        self,
        id: Annotated[StrictInt, Field(description="The ID of the async operation.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._api_v2_diagnostics_operations_export_id_result_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _api_v2_diagnostics_operations_export_id_result_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/diagnostics/operations/export/{id}/result',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api_v2_diagnostics_operations_export_post(
        self,
        diagnostic_component_context: Annotated[Optional[DiagnosticComponentContext], Field(description="The list of diagnostic components to export. If the list is empty, all components will be exported.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param diagnostic_component_context: The list of diagnostic components to export. If the list is empty, all components will be exported.
        :type diagnostic_component_context: DiagnosticComponentContext
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._api_v2_diagnostics_operations_export_post_serialize(
            diagnostic_component_context=diagnostic_component_context,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _api_v2_diagnostics_operations_export_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if diagnostic_component_context is not None:
            _body_params = diagnostic_component_context
