...
class TestEmulatedSubnetConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EmulatedSubnetConfig:
        """Test EmulatedSubnetConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmulatedSubnetConfig`
        """
        model = EmulatedSubnetConfig()
        if include_optional:
    ...
    def testEmulatedSubnetConfig(self):
        """Test EmulatedSubnetConfig"""
