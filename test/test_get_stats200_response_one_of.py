...
class TestGetStats200ResponseOneOf(unittest.TestCase):
    """GetStats200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStats200ResponseOneOf:
        """Test GetStats200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStats200ResponseOneOf`
        """
        model = GetStats200ResponseOneOf()
        if include_optional:
            return GetStats200ResponseOneOf(
                data = [
    ...
    def testGetStats200ResponseOneOf(self):
        """Test GetStats200ResponseOneOf"""
