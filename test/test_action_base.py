...
class TestActionBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionBase:
        """Test ActionBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionBase`
        """
        model = ActionBase()
        if include_optional:
            return ActionBase(
