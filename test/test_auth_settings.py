...
class TestAuthSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthSettings:
        """Test AuthSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthSettings`
        """
        model = AuthSettings()
        if include_optional:
            return AuthSettings(
                auth_method = 'AAA',
                auth_param = openapi_client.models.params.Params(
                    array_element_type = '', 
                    array_elements = [
                        {
                            'key' : ''
                ...
                passwords_param = openapi_client.models.params.Params(
                    array_element_type = '', 
                    array_elements = [
                        {
                            'key' : ''
                ...
                usernames_param = openapi_client.models.params.Params(
                    array_element_type = '', 
                    array_elements = [
                        {
                            'key' : ''
