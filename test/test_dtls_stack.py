...
class TestDTLSStack(unittest.TestCase):
    """DTLSStack unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DTLSStack:
        """Test DTLSStack
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DTLSStack`
        """
        model = DTLSStack()
        if include_optional:
            return DTLSStack(
