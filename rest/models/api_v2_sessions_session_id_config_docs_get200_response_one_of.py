...
class ApiV2SessionsSessionIdConfigDocsGet200ResponseOneOf(BaseModel):
    """
    ApiV2SessionsSessionIdConfigDocsGet200ResponseOneOf
    """ # noqa: E501
    data: Optional[OpenAPIDefinitions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": OpenAPIDefinitions.from_dict(obj["data"]) if obj.get("data") is not None else None,
