...
class IPNetwork(BaseModel):
    ...
    emulated_router: Dict[str, Any] = Field(alias="EmulatedRouter")
    eth_range: Optional[Dict[str, Any]] = Field(default=None, alias="EthRange")
    ip_ranges: List[IPRange] = Field(alias="IPRanges")
    ip_sec_stacks: List[IPSecStack] = Field(alias="IPSecStacks")
    tunnel_stacks: List[TunnelStack] = Field(alias="TunnelStacks")
